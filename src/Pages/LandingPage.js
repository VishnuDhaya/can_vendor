                    ...
                    <div className="d-flex align-items-center justify-content-end">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <div className="d-flex flex-column px-4 py-2">  
                                ...
                                <input className="p-1 mb-2 login-input" id="email" value = {userEntry.eamil} onChange={(e) => userEntryHandler(e.target.value, "email")}/>
                                <span className="my-1">Password</span>   
                                <input className="p-1 mt-1 mb-2 login-input" id="password" value = {userEntry.password} onChange = {(e) => userEntryHandler(e.target.value, "password")} />
                                <input className="landing-nav-btn p-1 w-100 mt-1" type = {"submit"} value = {"Login"} onClick = {(e) => submitClickHandler(e)}/>

                            </div>                      
                        </div>
                        <button className="landing-nav-btn p-1 mx-5">Free Trial</button>
                    </div>                
                </div>
            </div>
            <div className="row no-margin align-items-center">
                ...
                <div className="col-md-6 no-padding position-relative">
